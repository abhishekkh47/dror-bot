...
def load_test_cases(limit=5):
    """Load a small subset of test cases for CI to keep execution fast and cheap."""
...
async def test_rag_quality_metrics():
    ...
    """
    test_cases = load_test_cases(limit=5)
    ...
    assert mean_faithfulness >= 0.85, f"Faithfulness score {mean_faithfulness} is below threshold 0.85"
    
    mean_relevance = result["answer_relevance"]
